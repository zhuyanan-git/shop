...
package com.qfant.wx.api;


import com.qfant.utils.JsonUtils;
...
public class ApiResult implements Serializable {
    ...
    private static final Log logger = LogFactory.getLog(ApiResult.class);
    ...
    public ApiResult(String jsonStr) {
        ...
        try {
            Map<String, Object> temp = JsonUtils.getJsonToBean(jsonStr, Map.class);
            this.attrs = temp;
        } catch (Exception e) {
